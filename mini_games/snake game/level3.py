...
# Plotting Snake in game
    ...
    def Game_loop(self):
        ...
        rect_w = 20
        try:
            with open("highscoreLevel3.txt", 'r') as f:
                highscore = int(f.read())
        except:
            with open("highscoreLevel.txt", 'w') as f:
                highscore = 0
        # snake 
        Snake_size = 13
        Snake_x = 32
        ...
        while not exit_game:
            if game_over :
                with open("highscoreLevel3.txt", 'w')as f :
                ...
                if abs(food_x - Snake_x) <= 15 and abs(food_y - Snake_y) <= 15:
                    ...
                    score+=10
                    snake_length+=1
                # Collisions with the rectangles
                if (rect1_x < Snake_x  <  rect1_x + rect_l) and (rect1_y < Snake_y  < rect1_y + rect_w):
                # if (rect1_x < Snake_x  < (Snake_x + rect_l)) and (rect1_y < Snake_y  < (Snake_y + rect_w)):
                    game_over = True
                if (rect2_x < Snake_x < (rect2_x + rect_l)) and (rect2_y < Snake_y < (rect2_y + rect_w)):
                    game_over = True
                ...
                # Respawning snake at soft edges
                # if Snake_x >= self.screen_width:
                #     Snake_x = 0
                # elif Snake_x < 0:
                #     Snake_x = self.screen_width - Snake_size
                # if Snake_y >= self.screen_height:
                #         Snake_y = 0
                # elif Snake_y < 0:
                #         Snake_y = self.screen_height - Snake_size
                ...
                pygame.draw.rect(self.gameWindow,self.White, [rect1_x , rect1_y , rect_l , rect_w])
                pygame.draw.rect(self.gameWindow,self.White, [rect2_x , rect2_y , rect_l , rect_w])
